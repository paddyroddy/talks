...
::: {.fragment .fade-left} It is **highly recommended** to ensure you have tests
that will operate on the Renovate branches.
...
:::{layout-ncol=2} ![](figures/status_checks_1.png)

::: {.fragment .fade-left} ![](figures/status_checks_2.png) ::: :::

## Rulesets - Pull Requests

:::{layout-ncol=2} ![](figures/pull_requests_1.png)

::: {.fragment .fade-left} ![](figures/pull_requests_2.png) ::: :::

## Monitoring

:::{layout-ncol=2} ![](figures/logging_1.png)

::: {.fragment .fade-left} ![](figures/logging_2.png) ::: :::

::: footer See in action: <https://developer.mend.io/github/paddyroddy/.github>
:::
