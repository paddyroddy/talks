...
## Pedantic Mode {footer=false}

`zizmor --pedantic .github/workflows/demo.yaml`

The default persona prioritises actionable security findings; pedantic mode also
reports broader hardening and maintainability issues.
...
- Astral have a good
  ...
  written by `zizmor`'s author [William Woodruff](https://github.com/woodruffw).
- `zizmor` can be installed from Homebrew, PyPI, crates.io, Docker, …
