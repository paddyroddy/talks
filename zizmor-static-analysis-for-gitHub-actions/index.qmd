...
script. It is not equivalent to safely passing an ordinary string argument.
...
Keep data as data. Do not accidentally turn it into shell syntax.
...
A release workflow should build from reviewed source and locked dependencies—not
from mutable cache state supplied by an earlier, less-trusted workflow.
