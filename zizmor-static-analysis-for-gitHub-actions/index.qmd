...
A GitHub Actions workflow is an security-sensitive, executable program, not just
...
`zizmor --fix .github/workflows/demo.yaml`
...
```{.sh code-line-numbers="false"}
 INFO zizmor: 🌈 zizmor v1.28.0
 INFO audit: zizmor: 🌈 completed .github/workflows/demo.yaml                                                              No findings to report. Good job! (3 suppressed)
```
