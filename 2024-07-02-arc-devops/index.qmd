...
![Jira](figures/jira.png){width=50%} ![Trello](figures/trello.png){width=100%}
![Confluence](figures/confluence.png){width=50%}
...
![Azure Boards](figures/azure_boards.png){width=50%}
...
![Jenkins](figures/jenkins.png){width=45%}
![GitLab CI](figures/gitlab_ci.png){width=50%}
![GitHub Actions](figures/github_actions.png){width=50%}
...
![Selenium](figures/selenium.png){width=50%}
![JUnit](figures/junit.png){width=50%}
![Postman](figures/postman.png){width=50%}
...
![Ansible](figures/ansible.png){width=40%}
![Terraform](figures/terraform.png){width=40%}
![Kubernetes](figures/kubernetes.png){width=60%}
...
![Docker](figures/docker.png){width=60%}
![Puppet](figures/puppet.png){width=70%} ![Chef](figures/chef.png){width=60%}
...
![Prometheus](figures/prometheus.png){width=60%}
![Grafana](figures/grafana.png){width=50%}
![New Relic](figures/new_relic.png){width=30%}
...
![Slack](figures/slack.png){width=50%}
![Microsoft Teams](figures/microsoft_teams.png){width=50%}
![PagerDuty](figures/pager_duty.png){width=80%}
