...
Alternatively the helper function `array_api_compat.array_namespace(x)` can be
used to compute the `xp`.

:::

## Migration Guide {footer=false}
...
- [array-api](https://github.com/data-apis/array-api): outlines the standard.
- [array-api-compat](https://github.com/data-apis/array-api-compat):
  compatibility layer and helper functions.
- [array-api-extra](https://github.com/data-apis/array-api-extra): extra array
  functions.
- [array-api-strict](https://github.com/data-apis/array-api-strict): strict
  implementation useful for testing array consuming libraries.
- [array-api-tests](https://github.com/data-apis/array-api-tests): testing suite
  for array providing libraries.
- [array-api-typing](https://github.com/data-apis/array-api-typing): future
...
- The Python Array API allows library maintainers to support multiple array
  backends.
- Recommended to consult the standard and use `xp`/`.__array_namespace__()` for
  new code.
...
- Not all aspects of array backends are supported, e.g. random number
  generation, typing, …
- The standard comes with several packages to aid support: `array-api-compat`,
  `array-api-extra`, `array-api-strict`, `array-api-tests`, `array-api-typing`.
