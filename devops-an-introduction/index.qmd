...
{{< include /quarto-making-talks/_slides/flowcharts.qmd >}}
...
![Azure Boards](figures/azure-boards.png){width=35%}
...
![GitLab CI](figures/gitlab-ci.png){width=35%}
![GitHub Actions](figures/github-actions.png){width=35%}
...
![New Relic](figures/new-relic.png){width=35%}
...
![Microsoft Teams](figures/microsoft-teams.png){width=35%}
![PagerDuty](figures/pager-duty.png){width=35%}
