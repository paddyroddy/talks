...
In the order the repository files appear on GitHub.
...
[Listings](https://quarto.org/docs/websites/website-listings.html) enable one to
automatically generate the contents of a page from a list of Quarto documents or
other custom data.
...
Some talks include executable
[code chunks](https://quarto.org/docs/visual-editor/technical.html#code-chunks)
so these dependencies are for that Python code.
