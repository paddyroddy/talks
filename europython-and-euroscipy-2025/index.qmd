...
[![apache/arrow#47609](figures/apache-arrow.png){fig-alt="The typing stubs pull request." height=550}](https://github.com/apache/arrow/pull/47609)
...
![](figures/heatmap-prague.jpg){fig-alt="A map of my runs in Prague." width=65%}
...
![](figures/heatmap-krakow.jpg){width=90%}
