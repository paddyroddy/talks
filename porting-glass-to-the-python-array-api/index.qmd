...
- Adopt the [Python Array API Standard](https://data-apis.org/array-api) to
...
- The remaining gaps:
  ...
  - Minimising the overhead of moving arrays between different devices.
...
run as `uv run nox -s tests-3.14`.
...
- Test on CuPy following
  [v14 release](https://github.com/cupy/cupy/releases/tag/v14.0.0).
- Create scripts to benchmark on ARCHER2 using different array backends.
- Contribute remaining required functions to
  [array-api-extra](https://pypi.org/project/array-api-extra)
  {{< fa brands python >}}.
